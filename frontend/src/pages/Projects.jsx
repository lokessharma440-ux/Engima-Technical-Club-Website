        ...
        {projects.map((project, idx) => (
          ...
          >
            <div className="h-64 overflow-hidden relative border-b-4 border-black bg-gray-200">
              <img src={project.image?.startsWith('http') ? project.image : `http://localhost:5000${project.image}`} alt={project.title} className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-500" />
